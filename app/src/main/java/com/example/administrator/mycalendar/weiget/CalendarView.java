package com.example.administrator.mycalendar.weiget;
...
import com.example.administrator.mycalendar.R;
import com.example.administrator.mycalendar.bean.AttrsBean;
import com.example.administrator.mycalendar.bean.DateBean;
import com.example.administrator.mycalendar.listener.CalendarViewAdapter;
...
import com.example.administrator.mycalendar.listener.OnSingleChooseListener;
import com.example.administrator.mycalendar.utils.CalendarUtil;
import com.example.administrator.mycalendar.utils.SolarUtil;
...
public class CalendarView extends ViewPager {
     ...
     * @param position
     */
    public void refreshMonthView(int position) {
    ...
    public void addChooseDate(String date) {
        int[] dates = CalendarUtil.strToArray(date);
        int position = CalendarUtil.dateToPosition(dates[0], dates[1], startDate[0], startDate[1]);
        if (position == -1) {
            position = currentPosition;
        }
        HashSet<Integer> days = chooseDate.get(position);
